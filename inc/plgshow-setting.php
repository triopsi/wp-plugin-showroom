	...
	<div class="wrap">
		...
		<div id="post-body-content">
			<div id="plgshow-admin-page" class="meta-box-sortabless">
				<div id="plgshow-shortcode" class="postbox">
					<h3 class="hndle"><span><?php esc_html_e( 'How to use WP Plugin Showroom shortcode?', 'plgshow' ); ?></span></h3>
					<div class="inside">
						<h3 class="wp-pic-title"><?php esc_html_e( 'Shortcode parameters', 'plgshow' ); ?></h3>
						<ul>
							<li><strong>name:</strong> plugin name (Slug name) - <?php esc_html_e( 'the slug name of the plugin. https://wordpress.org/plugins/SLUG-NAME/', 'plgshow' ); ?></li>
							<li><strong>show_download_link:</strong> true/false - <?php esc_html_e( 'show the downloadlink? default: true', 'plgshow' ); ?></li>
							<li><strong>show_plugin_link:</strong> true/false - <?php esc_html_e( 'show the wordpresslink? default: true', 'plgshow' ); ?></li>
						</ul>
						<p><?php esc_html_e( 'Sample:', 'plgshow' ); ?></p>
						<p>
						...
						<div class="plgshow-wrap-option-page">
							<p class="trash_buffer">
								<button id="trash-buffer" target="_blank" class="button button-primary btn-trash-buffer" data-success="<?php esc_html_e( 'Buffer was successfully delete', 'plgshow' ); ?>" data-error="<?php esc_html_e( 'Something went wrong', 'plgshow' ); ?>">🚮 <?php esc_html_e( 'Delete buffer', 'plgshow' ); ?></button>
								<span class="trash-buffer-spinner" style="display: none; background-image: url( '<?php echo admin_url(); ?>images/spinner-2x.gif' );"></span>
							</p>
							<a href="https://paypal.me/triopsi" target="_blank" class="button button-secondary">❤️ <?php esc_html_e( 'Donate', 'plgshow' ); ?></a> 
							<a href="https://wiki.profoxi.de/" target="_blank" class="button button-secondary">ℹ️ <?php esc_html_e( 'Help', 'plgshow' ); ?></a> 
						</div>
					 </div>
				</div>
			</div>
		<?php if ( WP_DEBUG ) { ?>
			<div class="debug-info">
				<h3><?php esc_html_e( 'Debug information', 'plgshow' ); ?></h3>
				<p><?php esc_html_e( 'You are seeing this because your WP_DEBUG variable is set to true.', 'plgshow' ); ?></p>
